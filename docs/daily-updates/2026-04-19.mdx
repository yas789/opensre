...
- [#593](https://github.com/Tracer-Cloud/opensre/pull/593) feat(cli): add LangSmith deploy support to opensre deploy (author: Ceren Camkiran; contributors: Ceren Camkiran; labels: _none_; files: `app/cli/commands/deploy.py`, `app/cli/langsmith_deploy.py`, `tests/cli/test_deploy.py`, `tests/cli_smoke_test.py`)
